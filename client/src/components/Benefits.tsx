      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="rounded-2xl shadow-xl bg-white dark:bg-gray-900 p-8 aspect-video">
              <div className="h-full grid grid-cols-2 grid-rows-2 gap-4">
                ...
                <div className="bg-emerald-100 dark:bg-emerald-900/30 rounded-lg flex items-center justify-center">
                ...
                <div className="bg-amber-100 dark:bg-amber-900/30 rounded-lg flex items-center justify-center">
                ...
                <div className="bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center">
                  <svg className="w-12 h-12 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
