import { 
  ...
  quizAttempts, type InsertCodeSnippet, type CodeSnippet,
  codeSnippets, chatHistory, type ChatHistory, type InsertChatHistory,
  studyPlans, type StudyPlan, type InsertStudyPlan,
  achievements, userStats, type ChatMessage
} from "@shared/schema";
...
export interface IStorage {
  ...
  updateChatHistory(id: number, message: ChatMessage): Promise<ChatHistory | undefined>;
  ...
  updateUserStats(userId: number, stats: Partial<any>): Promise<any | undefined>;
}
